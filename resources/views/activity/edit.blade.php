...
<div class="flex items-center justify-center w-full h-full">
    <div class="w-full p-6 bg-white rounded-md shadow-md md:w-1/2 h-fit">
        <h2 class="mb-4 text-lg font-semibold text-gray-700 capitalize">Edit Transaksi Kas</h2>
            ...
            <div class="flex flex-col gap-y-6">
                <label class="w-full">
                    <div class="relative group">
                        <img src="{{ asset('storage/'.$activity->gambar) }}" alt="avatar" class="object-cover w-full rounded-md h-36 avatar-img">
                        <div class="absolute inset-0 flex-col items-center justify-center hidden w-full h-full transition bg-indigo-600 rounded-md group-hover:flex group-hover:bg-indigo-800 flex-nowrap">
                ...
                <div>
                    ...
                    <input class="w-full mt-2 rounded-md form-input focus:border-indigo-600" type="text" name="nama" required autofocus value="{{ old('nama',$activity->nama) }}">
                    @error('nama')
                ...
                <div>
                    ...
                    <input class="w-full mt-2 rounded-md form-input focus:border-indigo-600" type="text" name="deskripsi" required autofocus value="{{ old('deskripsi',$activity->deskripsi) }}">
                    @error('deskripsi')
                    <span class="text-sm font-semibold text-red-600">{{ $message }}</span>
                    @enderror
                </div>
