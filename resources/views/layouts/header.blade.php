<section class="flex items-center justify-between px-8 py-4 bg-white shadow-md navbar">
    ...
    <div class="items-center hidden md:flex gap-x-3">
        ...
        <a href="#about" class="px-3 py-2 text-base font-semibold transition text-slate-600 hover:bg-slate-600 hover:text-white">Tentang</a>
    ...
    <div class="fixed inset-0 w-screen h-screen bg-black/70" x-show="navbar" x-transition:enter="transition ease-out duration-300"
